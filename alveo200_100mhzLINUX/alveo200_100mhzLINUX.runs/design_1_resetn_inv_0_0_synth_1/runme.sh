...
HD_PWD='/work/zain/Xilinx/alveo200_100mhzLINUX/alveo200_100mhzLINUX.runs/design_1_resetn_inv_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_resetn_inv_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_resetn_inv_0_0.tcl
